    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', cloudinary.models.CloudinaryField(
                    default='https://res.cloudinary.com/dn3laf4bh/image/upload/v1647623057/avatar_iu9mmi.svg', max_length=255, verbose_name='image')),
                ('friends', models.ManyToManyField(blank=True,
                 related_name='friends1', to=settings.AUTH_USER_MODEL)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.',
                 related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('pending_invs', models.ManyToManyField(blank=True,
                 related_name='pending_invs1', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', cloudinary.models.CloudinaryField(blank=True,
                 default='', max_length=255, null=True, verbose_name='image')),
                ...
                ('topic', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.CASCADE, to='core.topic')),
            ],
            options={
